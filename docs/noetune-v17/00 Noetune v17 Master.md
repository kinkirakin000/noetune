...
Phase 5B-2aとして、Final Measurement schema foundationとtyped Back-frame構造を受入した（commit `1dbca2af5b799f24a6e941a6ee2b1dde6036daab`）。Snapshot Schema v1を維持し、Final measurementのcanonical ownerは`measurement.after`、`finalMeasurementState`はprojectionとする。Final serializer / restore、Result / Repeat、Cloud、Guest persistent resumeは未完成である。
